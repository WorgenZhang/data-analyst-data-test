...
**Answer:** The appropriate method would be regression. We are interested in inference. Since CEO's salary is a continuous variable. And we want to know what variables impact it instead of predicting another CEO's salary.
n is number of manufacturing companies in Europe. p are predictors including industry, number of employees, and total profit.
